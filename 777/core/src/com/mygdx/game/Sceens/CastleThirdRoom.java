...
import static com.mygdx.game.Tools.Assets.Knight;
...
import static com.mygdx.game.Tools.Assets.ThirdRoom;
...
public class CastleThirdRoom implements Screen, InputProcessor {
    HighCastle game;
    SpriteBatch batch;
    ...
    public CastleThirdRoom(HighCastle game) {
        this.game = game;
        batch = new SpriteBatch();
        renderer = new OrthogonalTiledMapRenderer(ThirdRoom);
        ...
        units[1] = new Unit(200, 200, world, Knight);
        units[2] = new Unit(1720, 200, world, Knight);
        units[3] = new Unit(900, 850, world, Knight);
        units[4] = new Unit(1000, 900, world, Knight);
    ...
    public void render(float delta) {
        ...
        if (Gdx.input.justTouched()) {
            ...
            if(((touchX >= ActionButtonClass.position.x) && touchX <= (ActionButtonClass.position.x + ActionButtonClass.width) && (touchY >= ActionButtonClass.position.y)
                    && touchY <= (ActionButtonClass.position.y + ActionButtonClass.height)) &&
                    ((units[0].getpX() < units[1].getpX()+150) && (units[0].getpX() > units[1].getpX()-150) && (units[0].getpY() < units[1].getpY()+150) && (units[0].getpY() > units[1].getpY()-150))
                    && Blade == false){
                batch.draw(Sword, units[0].getpX()-125, units[0].getpY()-50, 75, 75);
                Sword.rotate90(true);
            ...
            if(((touchX >= ActionButtonClass.position.x) && touchX <= (ActionButtonClass.position.x + ActionButtonClass.width) && (touchY >= ActionButtonClass.position.y)
                    && touchY <= (ActionButtonClass.position.y + ActionButtonClass.height)) &&
                    ((units[0].getpX() < units[2].getpX()+150) && (units[0].getpX() > units[2].getpX()-150) && (units[0].getpY() < units[2].getpY()+150) && (units[0].getpY() > units[2].getpY()-150))
                    && Blade == false){
                batch.draw(Sword, units[0].getpX()-125, units[0].getpY()-50, 75, 75);
                Sword.rotate90(true);
            ...
            if(((touchX >= ActionButtonClass.position.x) && touchX <= (ActionButtonClass.position.x + ActionButtonClass.width) && (touchY >= ActionButtonClass.position.y)
                    && touchY <= (ActionButtonClass.position.y + ActionButtonClass.height)) &&
                    ((units[0].getpX() < units[3].getpX()+150) && (units[0].getpX() > units[3].getpX()-150) && (units[0].getpY() < units[3].getpY()+150) && (units[0].getpY() > units[3].getpY()-150))
                    && Blade == false){
                batch.draw(Sword, units[0].getpX()-125, units[0].getpY()-50, 75, 75);
                Sword.rotate90(true);
            ...
            if(((touchX >= ActionButtonClass.position.x) && touchX <= (ActionButtonClass.position.x + ActionButtonClass.width) && (touchY >= ActionButtonClass.position.y)
                    && touchY <= (ActionButtonClass.position.y + ActionButtonClass.height)) &&
                    ((units[0].getpX() < units[4].getpX()+150) && (units[0].getpX() > units[4].getpX()-150) && (units[0].getpY() < units[4].getpY()+150) && (units[0].getpY() > units[4].getpY()-150))
                    && Blade == false){
                batch.draw(Sword, units[0].getpX()-125, units[0].getpY()-50, 75, 75);
                Sword.rotate90(true);
    ...
    public void generalupdate(Vector3 touch, OrthographicCamera camera){
        ...
        if(samX > 1900){
            //game.setScreen(new CastlefourthRoom(game));
            dispose();
        }
        ...
        if(units[0].getpY()>980 && Japanese == true){
            game.setScreen(new Story5JP(game));
            dispose();
        }
        if(units[0].getpY()>980 && Russian == true){
            game.setScreen(new Story5Rus(game));
            dispose();
        }
